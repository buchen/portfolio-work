...
public class Messages extends NLS
{
    ...
    public static String LedgerDiagnosticMessageFormatterAccount;
    public static String LedgerDiagnosticMessageFormatterAmount;
    public static String LedgerDiagnosticMessageFormatterContextUnavailable;
    public static String LedgerDiagnosticMessageFormatterDate;
    public static String LedgerDiagnosticMessageFormatterIsin;
    public static String LedgerDiagnosticMessageFormatterNote;
    public static String LedgerDiagnosticMessageFormatterPortfolio;
    public static String LedgerDiagnosticMessageFormatterSecurity;
    public static String LedgerDiagnosticMessageFormatterShares;
    public static String LedgerDiagnosticMessageFormatterSource;
    public static String LedgerDiagnosticMessageFormatterTicker;
    public static String LedgerDiagnosticMessageFormatterTransactionContext;
    public static String LedgerDiagnosticMessageFormatterType;
    public static String LedgerDiagnosticMessageFormatterUnnamedAccount;
    public static String LedgerDiagnosticMessageFormatterUnnamedPortfolio;
    public static String LedgerDiagnosticMessageFormatterUnnamedSecurity;
    public static String LedgerDiagnosticMessageFormatterWkn;
    public static String LedgerStructuralValidatorDividendSecurityRequired;
    ...
    public static String LedgerStructuralValidatorParameterMustUseValueKind;
    public static String LedgerStructuralValidatorParameterTypeRequired;
    public static String LedgerStructuralValidatorParameterValueKindMismatch;
    public static String LedgerStructuralValidatorParameterValueKindRequired;
